...
module router (
  ...
  always_ff @(posedge clk) begin
    if(!rst_n) begin
      ...
      if(east_in[36] == 1'b1 && east_in[33:32] == location[1:0]
         && east_in[35:34] < location[3:2] && east_in[35:34] != 2'b00) begin
          north_reg <= east_in;
                  ...
                  && west_in[35:34] < location[3:2] && east_in[35:34] != 2'b00) begin
          north_reg <= west_in;
      end else if(south_in[36] == 1'b1 && south_in[33:32] == location[1:0]
                  && south_in[35:34] < location[3:2] && east_in[35:34] != 2'b00) begin
          north_reg <= south_in;
      end else if(local_in[36] == 1'b1 && local_in[33:32] == location[1:0]
                  && local_in[35:34] < location[3:2] && east_in[35:34] != 2'b00) begin
          north_reg <= local_in;
      end
      ...
      if(west_in[36] == 1'b1 && west_in[35:32] == location[3:0]) begin
          local_reg <= west_in;
      end else if(east_in[36] == 1'b1 && east_in[35:32] == location[3:0]) begin
          local_reg <= east_in;
